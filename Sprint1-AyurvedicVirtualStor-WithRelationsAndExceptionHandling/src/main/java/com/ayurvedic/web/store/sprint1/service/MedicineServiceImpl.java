...
public class MedicineServiceImpl implements IMedicineService{
	...
	public Medicine viewMedicine(int medicineId) {
		...
		Optional<Medicine> medicinedToView = medicineRepository.findById(medicineId);
		
		if(medicinedToView.isPresent()){
			Medicine medicineViewed = medicinedToView.get();
			medicineRepository.findById(medicineId);
			return medicineViewed;
		}
			
		return medicinedToView.orElseThrow(()-> 
